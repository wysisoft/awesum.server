...
Get-ChildItem '../awesum.client/src/clientClasses/*.ts' -Recurse | ForEach-Object {(Get-Content $_) -replace '    private _(.*):(.*)(=.*)?;.*', '    private _$1:$2$3 = null;
public get $1():$2 | null { return this._$1; }public set $1(v:$2 | null) {this._$1=v;this.promises.push(Global.setTablePropertyValueById(this.id, ''$1'',v,this.table,this.promises))}' | Set-Content $_}
